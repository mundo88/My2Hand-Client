...
import { PiCompass, PiMessengerLogo, PiVideo } from 'react-icons/pi';
    ...
    return (
        <div className='w-full py-6 bg-white h-screen border-r'>
            <div className='w-full flex flex-col justify-between h-full'>
                <div>
                    <p className='text-2xl font-bold hover:text-gray-800 mx-6 pt-4 mb-10'>My2hand</p>
                    <div className='mx-4 space-y-3'>
                        <NavLink to={'/newfeed'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            ...
                            <GoHome className='text-gray-500 group-[.active]:text-gray-800' size={30}></GoHome>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Trang chủ</span>
                        </NavLink>
                        <NavLink to={'/search'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <IoIosSearch className='text-gray-500 group-[.active]:text-gray-800' size={30}></IoIosSearch>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Tìm kiếm</span>
                        </NavLink>
                        <NavLink to={'/explore'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <PiCompass  className='text-gray-500 group-[.active]:text-gray-800' size={30}></PiCompass>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Khám phá</span>
                        </NavLink>
                        <NavLink to={'/shop'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <HiOutlineShoppingBag className='text-gray-500 group-[.active]:text-gray-800' size={28}></HiOutlineShoppingBag>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Mua sắm</span>
                        </NavLink>
                        <NavLink to={'/watch'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <PiVideo  className='text-gray-500 group-[.active]:text-gray-800' size={30}></PiVideo>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Video</span>
                        </NavLink>
                        <NavLink to={'/message'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <PiMessengerLogo className='text-gray-500 group-[.active]:text-gray-800' size={30}></PiMessengerLogo>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Trò chuyện</span>
                        </NavLink>
                        <NavLink to={'/saved'} className='px-2 flex items-center py-1.5 hover:bg-gray-200 text-gray-800 rounded-lg duration-150 gap-3 group'>
                            <div className='w-9 h-9 overflow-hidden flex items-center justify-center'>
                                <GoHeart className='text-gray-500 group-[.active]:text-gray-800' size={28}></GoHeart>
                            </div>
                            <span className='group-[.active]:font-bold text-gray-800'>Đã lưu</span>
                        </NavLink>
